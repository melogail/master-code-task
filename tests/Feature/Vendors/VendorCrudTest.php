...
class VendorCrudTest extends TestCase
{
    ...
    public function test_admin_can_delete_vendor()
    {
        $this->actingAsAdmin();
    ...
    public function test_admin_can_view_soft_deleted_vendors()
    {
        $this->actingAsAdmin();
    ...
    public function test_admin_can_view_soft_deleted_vendor()
    {
        $this->actingAsAdmin();
    ...
    public function test_admin_can_restore_soft_deleted_vendor()
    {
        $this->actingAsAdmin();
        ...
        $this->assertNotSoftDeleted('vendors', [
            'id' => $vendor->id,
            'deleted_at' => null,
        ]);
    }

    public function test_admin_can_permanently_delete_soft_deleted_vendor()
    {
        $this->actingAsAdmin();
    ...
    public function test_staff_can_view_vendors()
    {
        $this->actingAsStaff();
